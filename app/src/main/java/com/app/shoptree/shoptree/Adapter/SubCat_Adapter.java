...
/**
 * Created by lovishbajaj on 05/09/17.
 */

public class SubCat_Adapter extends BaseAdapter {
    String[] imgt;
    private Context mcontext;
    int[] imgId;
    private ArrayList<CategoryModel> categories;
    private static LayoutInflater inflater = null;
    public SubCat_Adapter(Context context, ArrayList<CategoryModel> categories){
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        holder.catText=(TextView) rowView.findViewById(R.id.cat_text);
        holder.catImg=(ImageView) rowView.findViewById(R.id.cat_img);
